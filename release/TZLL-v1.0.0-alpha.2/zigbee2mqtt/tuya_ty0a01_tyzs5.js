...
// Stable production converter v1.2.2 for TYZS5 / srptwvak Stage 2G-R2.
// v1.2.2 fixes read-only credential bitmap indexing and adds DP93; write behavior is unchanged.
...
// ---- Readable lock-side credential ID lists (DP58/59/60/93) ----
// TARGET/legacy converter evidence shows these DPs use repeating shard/bitmap pairs:
//   [shard, bitmap], ID = (shard - 1)*8 + bit for each set bit 0..7.
// DP58 = fingerprint hardware IDs, DP59 = local/long-term password hardware IDs,
// DP60 = card hardware IDs, DP93 = face hardware IDs (observed extension). These are NOT DP24 temporary-password reference IDs.
//
...
module.exports = [
    {
        ...
        model: 'TY0A01-TYZS5',
        vendor: 'Tuya',
        description: 'Tuya TY0A01-TYZS5 Zigbee 智能门锁（TYZS5 / srptwvak，Stable v1.2.2）',
        ...
        meta: {
            tuyaDatapoints: [
                ...
                // DP58/59/60/93 are decoded by fzReadableCredentialIdLists; raw hex is not stored.
                // ---- records ----
