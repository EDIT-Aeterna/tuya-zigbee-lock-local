...
// The names of clusters that are not present, are removed.
  ...
  #define SILABS_PRINTCLUSTER_KAGEL_EF00_CLUSTER { ZCL_KAGEL_EF00_CLUSTER_ID, 0x0000, "Kagel EF00 Telemetry" },
  #define SILABS_PRINTCLUSTER_KAGEL_FC00_CLUSTER { ZCL_KAGEL_FC00_CLUSTER_ID, 0x1049, "Kagel FC00 Legacy" },
...
#define CLUSTER_IDS_TO_NAMES \
  ...
  SILABS_PRINTCLUSTER_KAGEL_EF00_CLUSTER \
  SILABS_PRINTCLUSTER_KAGEL_FC00_CLUSTER \
