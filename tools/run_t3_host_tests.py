...
for name, cmd in [('fixtures',['python','tests/run_fixtures.py']), ('bitmap',['node','tests/credential_bitmap_test.js']), ('bitmap_reference',['node','tests/credential_bitmap_regression.js'])]:
