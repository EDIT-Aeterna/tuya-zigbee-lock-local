...
Local firmware and Zigbee2MQTT integration for tested TYZS5 and TYZS3 locks using EFR32MG13P732F512GM48. This alpha adds Control and Monitor editions on the shared core and was published as a GitHub prerelease on 2026-09-20. Tuya Cloud and Tuya App compatibility are intentionally not retained.
...
- [v1.2.0-alpha.1 release notes](RELEASE_NOTES_v1.2.0-alpha.1_zh-en.md)
...
- [Original attribution](NOTICE.md) / [upstream relationship](docs/UPSTREAM_AND_PROVENANCE.md) / [license status](docs/LICENSE_RECOMMENDATION.md)
